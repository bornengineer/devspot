<template>
  ...
  <div class="containerr">
    ...
    <p>Welcome to encantotek!</p>
    <p>
      These terms and conditions outline the rules and regulations for the use
      of Encanto Technologies's Website, located at encantotek.com.
    </p>
    <p>
      By accessing this website we assume you accept these terms and conditions.
      Do not continue to use encantotek if you do not agree to take all of the
    ...
    <p>
      We employ the use of cookies. By accessing encantotek, you agreed to use
      cookies in agreement with the Encanto Technologies's Privacy Policy.
    </p>
    <p>
    ...
    <p>
      Unless otherwise stated, Encanto Technologies and/or its licensors own the
      intellectual property rights for all material on encantotek. All
      intellectual property rights are reserved. You may access this from
      encantotek for your own personal use subjected to restrictions set in
      these terms and conditions.
    </p>
    <p>You must not:</p>
    <ul>
      <li>Republish material from encantotek</li>
      <li>Sell, rent or sub-license material from encantotek</li>
      <li>Reproduce, duplicate or copy material from encantotek</li>
      <li>Redistribute content from encantotek</li>
    </ul>
    <p>
    ...
    <p>
      ...
      opinions and information in certain areas of the website. Encanto
      Technologies does not filter, edit, publish or review Comments prior to
      their presence on the website. Comments do not reflect the views and
      opinions of Encanto Technologies,its agents and/or affiliates. Comments
      reflect the views and opinions of the person who post their views and
      opinions. To the extent permitted by applicable laws, Encanto Technologies
    ...
    <p>
      Encanto Technologies reserves the right to monitor all Comments and to
    ...
    <p>
      You hereby grant Encanto Technologies a non-exclusive license to use,
    ...
    <p>
      ...
      hyperlink compensates the absence of Encanto Technologies; and (d) the
    ...
    <p>
      ...
      e-mail to Encanto Technologies. Please include your name, your
    ...
    <p>
      No use of Encanto Technologies's logo or other artwork will be allowed for
