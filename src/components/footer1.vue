  ...
  <footer>
    ...
    <div class="bottom_content">
      ...
      <section class="d-flex justify-content-sm-center">
        ...
        <router-link class="ham-list" to="/contact">Contact</router-link>
      </section>
    </div>
    <div class="copyright">
...
.border-shape {
  background: #c8cecf none repeat scroll 0 0;
  color: rgb(27, 151, 235);
  display: block;
  height: 3px;
  left: 0;
  margin: 20px auto;
